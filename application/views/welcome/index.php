...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    <p><a href="javascript:void(0);" onclick="startIntro();" class="btn btn-demo btn-large" data-dismiss="modal">Demo as Merchant</a><a href="javascript:void(0);" onclick="startIntro();" class="btn btn-demo btn-large" color="red" data-dismiss="modal">Demo as Buyer</a></p>
  </div>
</div>
